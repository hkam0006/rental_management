    ...
    <div className="dashboard-container">
      ...
      >
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger key="pending" value="pending">Pending</TabsTrigger>
          <TabsTrigger key="approved" value="approved">Approved</TabsTrigger>
          <TabsTrigger key="denied" value="denied">Denied</TabsTrigger>
        </TabsList>
                ...
                >
                  <div className="flex justify-between gap-5 w-full pb-4 px-4">
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/managers/properties/${"something"}`}

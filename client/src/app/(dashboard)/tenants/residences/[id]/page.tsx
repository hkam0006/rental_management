...
import { ArrowDownToLineIcon, Check, CreditCard, Download, Edit, Mail, MapPin, User } from 'lucide-react'
...
const Residence = () => {
  ...
  if (propertyLoading || leasesLoading || paymentsLoading) return <LoadingComponent />
